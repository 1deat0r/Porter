...
- Secrets guard: every commit runs scripts/pre-commit (installed at .git/hooks/pre-commit) — blocks key-like values and vault files. Names of env vars are fine; values never.
